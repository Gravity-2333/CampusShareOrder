...
const hallTips = computed(() => {
  ...
  return '大厅列表优先承接浏览、筛选、加入和跳转详情，不在列表页重复复杂业务推导。'
})
...
<template>
  <div class="stack-page">
    ...
    <PageSection
      v-loading="orderStore.hallLoading"
      title="拼单大厅"
      description="大厅页对齐 GET /api/orders 分页契约，并保持 mock / live 提供者可切换。"
    >
      ...
      <div class="page-actions wrap-actions">
        ...
        <el-button plain @click="handleOpenMyOrders">查看我的拼单</el-button>
      </div>
        ...
        <div class="order-grid">
          ...
          >
            ...
            <div class="page-actions">
              <el-button @click="handleViewDetail(order.orderId)">查看详情</el-button>
              <el-button
                type="primary"
                plain
